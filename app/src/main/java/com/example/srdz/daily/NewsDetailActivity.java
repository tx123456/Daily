...
public class NewsDetailActivity extends AppCompatActivity implements RevealBackgroundView.OnStateChangeListener{
    ...
    private void initView() {
        ...
        GlideUtils.getInstance().loadImageView(this, storiesBean.getImages().get(0), ivTitle);
